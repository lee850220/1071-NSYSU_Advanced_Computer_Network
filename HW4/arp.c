 ...
 *  Output:	void
 */
void set_ether_dhost(struct ether_header* packet, uchar* address) {
 ...
 *  Output:	void
 */
void set_ether_shost(struct ether_header* packet, uchar* address) {
 ...
 *  Output:	void
 */
void set_hard_size(struct ether_arp* packet, uchar size) {
 ...
 *  Output:	void
 */
void set_prot_size(struct ether_arp* packet, uchar size) {
 ...
 *  Output:	void
 */
void set_sender_hardware_addr(struct ether_arp* packet, uchar* address) {
 ...
 *  Output:	void
 */
void set_sender_protocol_addr(struct ether_arp* packet, uchar* address) {
 ...
 *  Output:	void
 */
void set_target_hardware_addr(struct ether_arp* packet, uchar* address) {
 ...
 *  Output:	void
 */
void set_target_protocol_addr(struct ether_arp* packet, uchar* address) {
