...
void set_ether_dhost(struct ether_header*, u8*);
void set_ether_shost(struct ether_header*, u8*);
...
void set_hard_size(struct ether_arp*, u8);
void set_prot_size(struct ether_arp*, u8);
void set_op_code(struct ether_arp*, short);

void set_sender_hardware_addr(struct ether_arp*, u8*);
void set_sender_protocol_addr(struct ether_arp*, u8*);
void set_target_hardware_addr(struct ether_arp*, u8*);
void set_target_protocol_addr(struct ether_arp*, u8*);
